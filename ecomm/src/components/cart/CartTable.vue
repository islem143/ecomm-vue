<template>
    <div>
        ...
        <Dialog v-model:dialogVisible="productDialog" :style="{width: '450px'}" header="Product Details" :modal="true" class="p-fluid">
        ...
        <Dialog v-model:dialogVisible="deleteProductDialog" :style="{width: '450px'}" header="Confirm" :modal="true">
        ...
        <Dialog v-model:dialogVisible="deleteProductsDialog" :style="{width: '450px'}" header="Confirm" :modal="true">
            <div class="confirmation-content">
                <i class="pi pi-exclamation-triangle mr-3" style="font-size: 2rem" />

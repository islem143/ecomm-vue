globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///home/islem/Documents/programming/ecomm-vue/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///home/islem/Documents/programming/ecomm-vue/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery, createError } from 'file:///home/islem/Documents/programming/ecomm-vue/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///home/islem/Documents/programming/ecomm-vue/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///home/islem/Documents/programming/ecomm-vue/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///home/islem/Documents/programming/ecomm-vue/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///home/islem/Documents/programming/ecomm-vue/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///home/islem/Documents/programming/ecomm-vue/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///home/islem/Documents/programming/ecomm-vue/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/islem/Documents/programming/ecomm-vue/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///home/islem/Documents/programming/ecomm-vue/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///home/islem/Documents/programming/ecomm-vue/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///home/islem/Documents/programming/ecomm-vue/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery } from 'file:///home/islem/Documents/programming/ecomm-vue/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/islem/Documents/programming/ecomm-vue/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/islem/Documents/programming/ecomm-vue/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/islem/Documents/programming/ecomm-vue/node_modules/radix3/dist/index.mjs';
import * as vue$1 from 'file:///home/islem/Documents/programming/ecomm-vue/node_modules/vue/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/islem/Documents/programming/ecomm-vue/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/islem/Documents/programming/ecomm-vue","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/islem/Documents/programming/ecomm-vue/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/islem/Documents/programming/ecomm-vue/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/islem/Documents/programming/ecomm-vue/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
var basestyle_cjs = BaseStyle$1m;

const BaseStyle$1n = /*@__PURE__*/getDefaultExportFromCjs(basestyle_cjs);
...
var BaseComponentStyle = BaseStyle__default$1l["default"].extend({
  name: 'common',
  css: css$19,
...
var AutoCompleteStyle = BaseStyle__default$1k["default"].extend({
  name: 'autocomplete',
  css: css$18,
  classes: classes$1j,
...
var CalendarStyle = BaseStyle__default$1j["default"].extend({
  name: 'calendar',
  css: css$17,
  classes: classes$1i,
...
var CascadeSelectStyle = BaseStyle__default$1i["default"].extend({
  name: 'cascadeselect',
  css: css$16,
  classes: classes$1h,
...
var CheckboxStyle = BaseStyle__default$1h["default"].extend({
  name: 'checkbox',
  classes: classes$1g
});
...
var ChipsStyle = BaseStyle__default$1g["default"].extend({
  name: 'chips',
  css: css$15,
  classes: classes$1f
});
...
var ColorPickerStyle = BaseStyle__default$1f["default"].extend({
  name: 'colorpicker',
  css: css$14,
  classes: classes$1e
});
...
var DropdownStyle = BaseStyle__default$1e["default"].extend({
  name: 'dropdown',
  css: css$13,
  classes: classes$1d
});
...
const _lazy_vzI8oV = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_vzI8oV, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_vzI8oV, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/home/islem/Documents/programming/ecomm-vue/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/home/islem/Documents/programming/ecomm-vue/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"utf-8\">\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<title>Sakai Vue</title>\n<link id=\"theme-css\" rel=\"stylesheet\" type=\"text/css\" href=\"/themes/mdc-light-indigo/theme.css\">","bodyTags":"","bodyTagsOpen":"","htmlAttrs":"","bodyAttrs":""};
